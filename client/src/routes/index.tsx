...
import { ProfileHeader } from '@/components/layout/Header/ProfileHeader/ProfileHeader';
...
export enum RouteNames {
	...
	MY_PROFILE = RouteBase.MY_PROFILE,
...
> = {
	...
	[RouteBase.LIKES]: [<BackHeader title='Посмотреть лайки' />, false],
	[RouteBase.PROFILE]: [<ProfileHeader />, true],
	[RouteBase.MY_PROFILE]: [<DefaultHeader />, true],
...
export const privateRoutes: IRoute[] = [
	...
	{ path: RouteNames.SETTINGS, component: SettingsPage },
	{ path: RouteNames.REELS, component: Page404 },
	{ path: RouteNames.PLACES, component: PlacesPage },
	...
	{ path: RouteNames.MY_PROFILE, component: MyProfilePage },
